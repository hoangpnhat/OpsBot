...
Nhạc phát tại cửa hàng, Bảo hành sửa chữa, Cân tồn sản phẩm, Cập nhật đơn hàng O2O, Cập nhật đơn hàng Offline, Cập nhật đơn hàng Online, Cập nhật đơn hàng Sàn TMĐT, Cuộc gọi nhỡ từ CH, Check camera, Chính sách đổi trả - bảo hành, Chính sách tích điểm - sử dụng điểm, Điều chuyển hàng hóa, Hóa đơn VAT, Hoàn tiền, Không cần hỗ trợ, Hỗ trợ livestream Tiktok, Lỗi hệ thống, Hỗ trợ tài khoản MXH (Zalo , FB...), Phần mềm Nhanh.vn, Phần mềm Antbuddy, Phần mềm 1Office, Phần mềm Gapo, Phần mềm Unicorn, Phần mềm Caresoft, Hỗ trợ setup thiết bị, Chương trình sinh nhật, Thanh toán, Sản phẩm (Hình ảnh,sty, trạng thái...), Tiếp nhận góp ý/ phản ánh/ khiếu nại Khách hàng, Tìm đơn hàng, Tồn kho sản phẩm, Ưu đãi nhân viên, Các vấn đề khác, Chương trình VIP
